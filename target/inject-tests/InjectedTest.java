...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/home/user/spark-plugin/spark-message");
    parameters.put("artifactId","spark-message");
    parameters.put("outputDirectory","/home/user/spark-plugin/spark-message/target/classes");
    parameters.put("testOutputDirectory","/home/user/spark-plugin/spark-message/target/test-classes");
